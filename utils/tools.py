...
class Projector(object):
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.CreateFeatureDataset_management(arcpy.env.scratchWorkspace, "MilesSplit",
                                              "Z:/Team/Crow/ArcTools/HardCodedPolygons/UTM11N.prj")
        arcpy.CreateFeatureDataset_management(arcpy.env.scratchWorkspace, "PointsSplit",
                                              "Z:/Team/Crow/ArcTools/HardCodedPolygons/UTM11N.prj")
        ...
        arcpy.Split_analysis(in_features=toProjectFile, split_features=zonesFile, split_field="Name",
        ...
        arcpy.Split_analysis(in_features=milesFile, split_features=zonesFile, split_field="Name",
        ...
        for item in zonesList:
            if arcpy.Exists(scratch + "/PointsSplit/" + item) and arcpy.Exists(
                ...
                arcpy.Near_analysis(in_features=scratch + "/PointsSplit/" + item,
                ...
                arcpy.JoinField_management(in_data=scratch + "/PointsSplit/" + item, in_field="NEAR_FID",
